...
ActiveRecord::Schema[7.1].define(version: 2024_09_29_172048) do
  ...
  create_table "tagged_friends", force: :cascade do |t|
    t.integer "event_picture_id", null: false
    t.integer "user_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["event_picture_id"], name: "index_tagged_friends_on_event_picture_id"
    t.index ["user_id"], name: "index_tagged_friends_on_user_id"
  end
  ...
  add_foreign_key "tagged_friends", "event_pictures"
  add_foreign_key "tagged_friends", "users"
end
